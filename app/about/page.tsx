          ...
          <div className="grid md:grid-cols-[2fr_1fr] gap-16 items-start">
            <div className="prose prose-lg dark:prose-invert">
              ...
              <p>
                ...
                product and engineering teams to deliver impactful digital products. I believe in a user-centered design
                approach that balances business goals with user needs.
              </p>
              <p>
                My design process involves deep research, strategic thinking, and iterative design. I'm passionate about
                creating products that not only look good but also solve real problems for users.
              </p>
            </div>
          ...
          <div className="grid gap-16 border-t border-gray-200 dark:border-gray-800 pt-16">
            ...
            <div className="grid gap-16">
              <div className="grid gap-4">
                ...
                <p>
                  Led the design of a B2B platform that streamlined workflow for enterprise clients. Managed a team of 3
                  designers and established the company's first design system.
                </p>
              </div>
              <div className="grid gap-4">
                <div className="flex justify-between items-baseline">
